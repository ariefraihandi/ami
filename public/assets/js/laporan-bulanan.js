function updateUrl() {
    ...
    var selectedOption = bulanSelect.options[bulanSelect.selectedIndex];
    var startDate = selectedOption.getAttribute('data-startDate');
    var endDate = selectedOption.getAttribute('data-endDate');
    
    // Redirect ke URL yang diinginkan dengan parameter tanggal
    var newURL = '/laporan/bulanan/?startDate=' + startDate + '&endDate=' + endDate;
