...
<head>
    ...
    <title>Invar - Invoice HTML Template - Photography Invoice</title>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets') }}/img/favicons/fav-icon.png">
    <link rel="manifest" href="{{ asset('assets') }}/img/favicons/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="{{ asset('assets') }}/img/favicons/fav-icon.png">
...
==============================-->
                            ...
                            <div class="row align-items-center justify-content-end">
                                <div class="col-auto">
                                    <div class="header-logo">
                                        <a href="index.html"><img src="{{ asset('assets') }}/img/logo-photography.svg" alt="Invar"></a>
                                    </div>
                                </div>
                            </div>
                        </header>
                        <div class="row justify-content-between mb-30 mt-5 pt-4">
                            ...
                            <div class="col-auto">
                                <div class="invoice-left">
                                    <b>Invar Photo studio:</b>
                                    <address>
                                        4510 E 96th St, Indianapolis,<br>
                                        125 CXR United States <br>
                                        info@invcephotostudio.com <br>
                                        +153 3256 3548
                                    </address>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                ...
                                <div class="invoice-left">
                                    ...
                                    <p class="mb-0">Authoritatively envisioned business action <br> items through parallel.<br>
                                </div>
                            </div>
                            <div class="col-auto">
